...
llm = ChatOpenAI(model='gpt-3.5-turbo-16k',temperature=0.3, api_key=settings.OPENAI_API_KEY)
...
def gen_model(transcript: str | Sequence[str], usernote: str):
    ...
    """
    prompt_template = PromptTemplate(input_variables=["raw_transcript"], template=template)
...
- Word RAM model of computation
    ...
    prompt_template = PromptTemplate(
        input_variables=["transcript"], template=writingstemplate
    )
